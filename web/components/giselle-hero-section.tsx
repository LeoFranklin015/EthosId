        ...
        <div className="text-center space-y-8 max-w-5xl mx-auto px-8 py-20">
          ...
          <div className="space-y-6 relative z-50">
            <div
              ...
              style={{
                textShadow: "0 0 30px rgba(255,255,255,0.35), 0 0 60px rgba(255,255,255,0.2)",
              }}
            >
              <span className="text-5xl md:text-6xl font-semibold tracking-tight text-white">EthosID</span>
            </div>

            <div className="space-y-2">
              <h1
                className="text-3xl md:text-4xl font-extralight text-white leading-tight font-sans relative z-50 text-balance"
                style={{
                  textShadow: "0 0 30px rgba(255, 255, 255, 0.3), 0 0 60px rgba(255, 255, 255, 0.1)",
                }}
              >
                Your identity, stamped by your country—on ENS
              </h1>
            </div>
          </div>
          ...
          <div className="space-y-4 max-w-4xl mx-auto relative z-50">
            <p className="text-xl text-slate-300 leading-relaxed drop-shadow-lg font-sans text-pretty">
              Claim a country-verified ENS like {"alice.india.eth"}. Carry trust into wallets, marketplaces, and
              communities—without leaking personal data.
            </p>
          </div>

          {/* CTA Button - link to /claim */}
          <div className="flex justify-center pt-8 relative z-50">
            <Link href="/claim" aria-label="Claim your name" className={getGlowButtonClasses()}>
