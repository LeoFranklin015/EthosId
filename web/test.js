...
function resolveEns(name) {
    return __awaiter(this, void 0, void 0, function () {
        var publicClient, normalized, resolverAddress, ensAddress, twitterHandle;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    normalized = (0, ens_1.normalize)(name);
                    return [4 /*yield*/, publicClient.getEnsResolver({
                            name: normalized,
                        })];
                case 1:
                    resolverAddress = _a.sent();
                    console.log("Resolver address:", resolverAddress);
                    return [4 /*yield*/, publicClient.getEnsAddress({
                            name: normalized,
                        })];
                case 2:
                    ensAddress = _a.sent();
                    console.log("ENS resolves to:", ensAddress);
                    return [4 /*yield*/, publicClient.getEnsText({
                            name: normalized,
                            key: "com.twitter",
                        })];
                case 3:
                    twitterHandle = _a.sent();
